...
public class RefreshTokenUseCase {
	...
	public Cookie gen(UserEntity user) throws JWTCreationException, AssertionError {
		Instant now = LocalDateTime
			.now()
		...
		try {
			var cookie = new Cookie(
				"refresh-token", 
				URLEncoder.encode(formattedToken, StandardCharsets.UTF_8.toString())
			);
	...
	public UserEntity validate(String value) throws JWTVerificationException, UsernameNotFoundException {
		try {
			var decodedValue = URLDecoder.decode(value, StandardCharsets.UTF_8.toString());
